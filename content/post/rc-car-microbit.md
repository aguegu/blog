...
![模块分布](/images/microbit-overview.png)
...
在 micro:bit blue 应用中，有一个游戏手柄的应用，这个是 micro:bit 非常吸引我的地方，而在以往的经验中，想作遥控车子，就要同时开发小车端和遥控端，如果还要移动端的话，还要折腾移动应用开发，一想就是头很大的时期。而 micro:bit blue / bitty controller 上已经提供了手柄应用的话，那么基本就只有小车端要开发了。而且，使用蓝牙还有个天然优势，就是配对的支持，这就让同时可以跑多辆车，而不用担心干扰的问题。
...
* 福州哈雷创客空间 本文的主要内容是 2017年11月24日 在哈雷创客空间进行的 micro:bit 分享会，我作为主讲人之一，将我所分享的内容，重新整理过后发布在这里。
* [purplepalmdash.github.io](https://purplepalmdash.github.io) 我的 Hugo 引路人

# 参考资料

* [电路图](https://github.com/bbcmicrobit/hardware/blob/master/SCH_BBC-Microbit_V1.3B.pdf)
